...
import { GET_LEVEL_CONFIG } from "../../../../../graphql/query/allQuery";
...
const FlipMode = () => {
  ...
  const [levelconfig_getLevelconfigs, { loading: loading5, error: error5, data: levelconfig }] = useLazyQuery(GET_LEVEL_CONFIG, {
  ...
  return (
    <StudyLayout>
      <div style={{ height:"100%", width: "95%", margin: "auto", marginTop: "50px" }}>
