...
const DetailIntro = () => {
  ...
  return (
    <DetailIntroWrap>
      ...
      <DetailIntroContentBookIntro active={active} content_item={NodeFromIntroBook} />
      <DetailIntroContentIndex active={active} content_item={NodeFromIndex} />
      <DetailIntroContentAuthorIntro active={active} content_item={NodeFromIntroAuthor} />
    </DetailIntroWrap>
  );
};
