    ...
    <>
      ...
      <Modal title="새카드 템플릿" visible={visible} onOk={handleOk} onCancel={handleCancel} okText="만들기" cancelText="취소" maskClosable={false} width={700}>
        <div
          ...
          style={{ fontSize: "11px", display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "space-evenly" }}
        >
          <div style={{ width: "100%" }}>
          ...
          <div style={{ width: "100%" }}>
            ...
            <Radio.Group onChange={onChange} style={{ fontSize: "11px", height: "100%" }} defadivtValue={type}>
              ...
              <Radio style={radioStyle} onChange={noneStudyOnchange} value="subject">
                <span style={{ marginRight: "10px" }}>비학습 - 제목카드</span>
              </Radio>
              <Radio style={radioStyle} onChange={shareStudyOnchange} value="general">
                <span style={{ marginRight: "10px" }}>비학습 - 일반카드</span>
