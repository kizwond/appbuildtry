...
import { AppstoreAddOutlined, DeleteOutlined, FileSyncOutlined, FlagOutlined, FundViewOutlined, RiseOutlined } from '@ant-design/icons';
...
const BookSetting = () => {
  ...
  const { data, loading, error } = useQuery(GET_MY_BOOK_BY_BOOK_IDS__AND_ALL_BOOK_CATEGORIES, {
    onCompleted: (_data) => {
      if (_data.mybookcateset_getMybookcatesetByUserID.status === '200' && _data.mybook_getMybookByMybookIDs.status === '200') {
        console.log('책 1권 정보 및 모든 책 카테 정보 받음', _data);
      } else if (_data.mybookcateset_getMybookcatesetByUserID.status === '401') {
      ...
      case 'select_category':
        return (
          <M_ReAssignBookToAnotherCategory
            ...
            cateIdNow={data.mybook_getMybookByMybookIDs.mybooks[0].mybook_info.mybookcate_id}
            categories={data.mybookcateset_getMybookcatesetByUserID.mybookcatesets[0].mybookcates}
            bookTitle={data.mybook_getMybookByMybookIDs.mybooks[0].mybook_info.title}
          />
        );
        break;
      case 'delete_book':
  ...
  return (
    <div>
      ...
      {data && data.mybook_getMybookByMybookIDs.mybooks.length === 1 && (
        <>
          <M_Layout>
            <StyledMainPageCard
              bordered={false}
              ...
              title={
                <>
                  ...
                  >
                    책 제목: {data.mybook_getMybookByMybookIDs.mybooks[0].mybook_info.title}
                  </StyledDivEllipsis>
            ...
            >
              <div>
                ...
                >
                  <Select.Option value="study_data_detail" label="학습 상세 정보 보기">
                    <Space>
                      <Avatar>
                        <RiseOutlined />
                      </Avatar>
                  ...
                  <Select.Option value="set_level_and_cycle" label="레벨 및 복습 주기 설정">
                    <Space>
                      <Avatar>
                        <FileSyncOutlined />
                      </Avatar>
