...
import BookListCarousel from "./BookListCarousel";

const BookListContainer = ({ children, bg_color, ft_color, clock, title, type }) => {
  if (type !== "table") {
    return (
      <BookListSectionWrapper bg_color={bg_color} ft_color={ft_color}>
        <SectionTitleText ft_color={ft_color}>
          {clock}
          {title}
        </SectionTitleText>
        <div>
      ...
      <div>
        <DivForPosition>
          <BookListTableWrapper>
            <ScrollBarHidden>
              <BookListTable>{children}</BookListTable>
            </ScrollBarHidden>
          </BookListTableWrapper>
        </DivForPosition>
      </div>
...
const SectionTitleText = styled.h2`
  ...
  font-size: 19px;
  font-weight: normal;
  color: ${(props) => props.ft_color || "black"};
...
const BookListTableWrapper = styled.div`
  position: relative;
`;

const BookListTable = styled.div`
  flex: 1 0 auto;
`;
