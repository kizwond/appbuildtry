    ...
    <table className="w-full table-fixed">
      <thead>
        <tr className="border-collapse border-y border-y-gray-200">
          <th className="text-[1rem] bg-slate-100 w-[20%]">플래그</th>
          <th className="text-[1rem] bg-slate-100">flag0</th>
          <th className="text-[1rem] bg-slate-100">flag1</th>
          <th className="text-[1rem] bg-slate-100">flag2</th>
          <th className="text-[1rem] bg-slate-100">flag3</th>
          <th className="text-[1rem] bg-slate-100">flag4</th>
          <th className="text-[1rem] bg-slate-100">flag5</th>
        </tr>
      </thead>
      <tbody>
